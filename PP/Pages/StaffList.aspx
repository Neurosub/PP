<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffList.aspx.cs" Inherits="PP.Pages.StaffList"  EnableEventValidation="false" %>
       ...
       <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">                   
                    <li class="nav-item">
                        <a class="nav-link active" href="StaffList.aspx" id="StaffList" aria-haspopup="true" aria-expanded="false">Список сотрудников
                        </a>
                    </li>
                    <li class="nav-item">
        ...
        <h1 class="title">Cписок сотрудников</h1>
        <div class="container">
            <div class="row justify-content-center">
                 <div class="row justify-content-center">
                 <div class="col-sm-10 col-md-8 col-lg-6">
                    <asp:TextBox class="form-control" ID="TextBox1" runat="server" type="search"></asp:TextBox> 
                      </div>
                ...
                <div class="form-row col-12">                                                      
                 ...
                 <div class="form-row col-12">
                    ...
                    <div class="form-group col-md-6">
                                <label class="lblText">Должность</label>
                                 <asp:Textbox class="form-control" ID="tbPosition" runat="server"></asp:Textbox> 
                                <asp:RequiredFieldValidator ID="tbPosition1" runat="server" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbPosition" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>                                                     
                            </div>
                        </div>
            </div>            
            <div class="row justify-content-center">
                <asp:GridView ID="gvStaff" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="True" CurrentSortDirection="ASC" Font-Size="16px" AlternatingRowStyle-Wrap="false"
                    HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvStaff_RowDataBound" OnSelectedIndexChanged="gvStaff_SelectedIndexChanged" OnRowDeleting="gvStaff_RowDeleting">
                     <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
            ...
            <div class="form-row col-12">
                ...
                <div class="form-group col-md-6">
                    <asp:Button ID="btUpdate" class="btn btn-outline-danger btn-block btn-lg" runat="server" OnClick="btUpdate_Click" Text="Изменить" /> 
                </div>                
            </div>  
        </div>
    </form>
